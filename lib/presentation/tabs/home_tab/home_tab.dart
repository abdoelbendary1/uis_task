                            ...
                            if (state is HomeLoadingState) ...[
                              ...
                              Expanded(
                                ...
                                child: GridView.builder(
                                  itemCount: state.homeResponseEntity!.data!
                                      .products!.length,
                                  gridDelegate:
                                    ...
                                    return InkWell(
                                        ...
                                        onTap: () {
                                          Navigator.of(context).pushNamed(
                                            ...
                                            arguments: state.homeResponseEntity!
                                                .data!.products![index],
                                          );
                                        },
                                        child: GridViewCardItem(
                                          product: state.homeResponseEntity!
                                              .data!.products![index],
                                        ));
                                  },
                                ),
                            ...
                            if (state is SearchLoadingState) ...[
                              ...
                              Expanded(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemCount: state
                                      .searchResponseEntity!.data!.data!.length,
                                  itemBuilder: (context, index) {
                                    return SearchItem(
                                      proudctEntity: state.searchResponseEntity!
                                          .data!.data![index],
                                      onTap: () {
                                        homeTabViewModel
